...
shadedErrorBar(1:20,nanmean(squeeze(temp2(:,87,:)),2),...
    nanstd(squeeze(temp2(:,10,:)),0,2)./sqrt(40),'--b')
...
shadedErrorBar(1:size(CellNum,2),nanmean(squeeze(temp2(8,:,:)),2),...
    nanstd(squeeze(temp2(8,:,:)),0,2)./sqrt(40),'--b')
...
subplot(122);imagesc(median(temp2,3)',[0 1])
axis('square');colormap('jet')
...
subplot(222);
temp = squeeze(mean(GENERAL_PERF_Mus,4));
imagesc(mean(temp,3)',[0 1])
axis('square');colormap('jet')

% subplot(223);imagesc(mean(MCperf_pre,3)',[0 1])
% axis('square');colormap('jet')
% 
% subplot(224);imagesc(mean(MCperf_mus,3)',[0 1])
% axis('square');colormap('jet')
%%
